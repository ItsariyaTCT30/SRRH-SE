          ...
          <div class="rooms_list">
            <ul>
              <li class="d-flex flex-row align-items-center justify-content-start">
                ...
                <span>อาหารเช้า <br /> Breakfast in the Restaurant</span>

              </li>
              <li class="d-flex flex-row align-items-center justify-content-start">
                <img src="images/check.png" alt="">
                <span>เตียงนอนคิงไซส์ , เตียงคู่ <br /> King Size Bed, offering a choice of Double or Twin Setup</span>

              </li>
              <li class="d-flex flex-row align-items-center justify-content-start">
                <img src="images/check.png" alt="">
                <span>บริการทำความสะอาดประจำวัน <br /> Daily Housekeeping services</span>

              </li>
            </ul>
          </div>
          <div class="rooms_price">4,500฿/<span>Night</span></div>
    ...
    <div class="row row-eq-height">
      ...
      <div class="col-xl-6 order-xl-2 order-1">
        <div class="rooms_right_content">
          ...
          <div class="rooms_price">1,500฿/<span>Night</span></div>
    ...
    <div class="row row-eq-height">
      ...
      <div class="col-xl-6">
        <div class="rooms_left_content">
          ...
          <div class="rooms_price">2,500฿/<span>Night</span></div>
