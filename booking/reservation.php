      ...
      <!--<div class="jumbotron">-->
        <div class="">
          ...
          <td valign="top" class="body" style="padding-bottom:10px;">
           ...
           Greetings from SRRH Beach Resorts!<br/><br/>
        ...
        <table class="table table-hover">
            ...
            <?php
             ...
             //  $departure = $_SESSION['to']; 
              ...
              foreach ($cur as $result) {
                ...
                echo '<td >1</td>';
                echo '<td >&dollar;'. $_SESSION['dragonhouse_cart'][$i]['dragonhouseroomprice'].'</td>'; 
                echo '</tr>';
              } 
          ...
          <tfoot>
            <tr>
              ...
              <td align="left">
              <h5><b> <?php echo '&dollar;' . $payable= $days*$result->PRICE; ?></b></h5>
...
If you have any questions, please email at SRRH.com or call (000) 000 – 0000
<br/><br/>
Thank you for choosing SRRH
<br/><br/>
