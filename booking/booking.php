...
<div id="accom-title" style="padding-top:50px ;">
  <div class="pagetitle">
    <h1 style="color:#F6A01B">Your Booking Cart
...
<table class="table" id="table" style="margin-top:30px ;">
  ...
  <tfoot style="background-color:#FFFFFF;color:black">
    <tr>
      <td colspan="6">
        <h4 align="right">Total:</h4>
      </td>
      <td colspan="4">
        <h4><b>&dollar;<span id="sum"><?php echo isset($_SESSION['pay']) ?  $_SESSION['pay'] : 'Your booking cart is empty.'; ?></span></b></h4>
